...
route.post('/', (0, validate_1.validate)(create_restaurant_validator_1.createRestro), authentication_middleware_1.authenticateToken, authentication_middleware_1.is_admin, RestroController.postRestro);
route.patch('/:id', (0, validate_1.validate)(create_restaurant_validator_1.updateRestroDto), authentication_middleware_1.authenticateToken, authentication_middleware_1.is_admin, RestroController.update);
